const mockData = {
    nodes: [
        {
            ...
            data: {
                ...
                icon: 'https://bp0r55-node-js.oss.laf.dev/calculator.svg',
                inputs: {},
                inputAnchors: [],
                inputParams: [],
                outputs: {},
        ...
        },
        {
            ...
            data: {
                ...
                inputs: {
                    openAIApiKey: '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',
    ...
    edges: [
        {
            source: 'calculator_0',
            sourceHandle: 'calculator_0-output-calculator-Calculator|Tool|StructuredTool|BaseLangChain',
            target: 'conversationalAgent_0',
            targetHandle: 'conversationalAgent_0-input-tools-Tool',
            type: 'buttonedge',
            id: 'calculator_0-calculator_0-output-calculator-Calculator|Tool|StructuredTool|BaseLangChain-conversationalAgent_0-conversationalAgent_0-input-tools-Tool',
            data: {
                label: ''
            }
        },
...
export function buildPreviewFlowData(t: any) {
    return {
        nodes: [
            {
                width: 300,
